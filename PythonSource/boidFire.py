from p5 import Vector, stroke, circle, fill
import numpy as np
    ...
    def coh(self, boids):
        ...
        if(total > 0):
            ...
            if(cMassVec.x > 0 and cMassVec.y > 0):
              ...
              cMassDir.x = cMassVec.x/float(cMassVecSize);
              cMassDir.y = cMassVec.y/float(cMassVecSize);
              steering.x = (cMassDir.x * 10);
              steering.y = (cMassDir.y * 10);
        ...
        if(total > 0):
            ...
            if(cMassVec.x > 0 and cMassVec.y > 0):
              ...
              if(cMassVecSize < 1):
                  ...
                  steering.x = (cMassDir.x * self.movePos)*(-0.1);
                  steering.y = (cMassDir.y * self.movePos)*(-0.1);
